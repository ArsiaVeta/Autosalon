package ru.arslanova.storageservice.config;
...
public class KafkaConfig {
    ...
    public static final String ORDER_SENT_DLT = ORDER_SENT_TOPIC + ".DLT";
    ...
    public static class Topics {
        ...
        @Bean
        public NewTopic orderSentDlt() {
            return TopicBuilder.name(ORDER_SENT_DLT).partitions(1).replicas(1).build();
        }
    }
